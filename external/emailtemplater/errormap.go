...
var EmailTemplaterErrorMap reply.ErrorManifest = map[string]reply.ErrorManifestItem{
	ErrKeyEmailTemplaterNoConfigProvided: {Title: "Internal Server Error", Detail: "Unable to process email request", StatusCode: 500, Code: "ET0-001"},
	ErrKeyEmailTemplaterTemplateNotFound: {Title: "Internal Server Error", Detail: "Unable to process email request", StatusCode: 500, Code: "ET0-002"},
	...
	ErrKeyEmailTemplaterTemplateRenderingFailed: {Title: "Internal Server Error", Detail: "Unable to process email request", StatusCode: 500, Code: "ET0-009"},
}
