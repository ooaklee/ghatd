...
func ExampleTemplaterProductionConfig() {
	config := &emailtemplater.Config{
		...
		DashboardVerificationURIPath:  "/verify",
...
func ExampleTemplaterCustomEmail() {
	config := &emailtemplater.Config{
		...
		Environment:                   "production",
		EmailVerificationFullEndpoint: "https://app.customapp.com/auth/verify",
		DashboardVerificationURIPath:  "/verify",
...
func ExampleTemplaterDashboardEmail() {
	config := &emailtemplater.Config{
		...
		DashboardDomainName:           "https://dashboard.example.com",
		Environment:                   "staging",
		EmailVerificationFullEndpoint: "https://dashboard.example.com/auth/verify",
