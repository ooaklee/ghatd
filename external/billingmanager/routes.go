...
const (
	// ApiBillingManagerPrefix base URI prefix for all billing manager v1 routes
	ApiV1BillingManagerPrefix = "/api/v1/bms"
)
...
func AttachRoutes(request *AttachRoutesRequest) {
	...
	billingmanagerOpenRoutes := httpRouter.PathPrefix(ApiV1BillingManagerPrefix).Subrouter()
	...
	billingmanagerActiveOnlyRoutes := httpRouter.PathPrefix(ApiV1BillingManagerPrefix).Subrouter()
	...
	billingmanagerAdminRoutes := httpRouter.PathPrefix(ApiV1BillingManagerPrefix + "/admin").Subrouter()
