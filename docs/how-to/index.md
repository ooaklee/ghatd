...
| ***Authentication*** <br><br>Authenticating a web, native, or hybrid app with Access Manager | <ul><li>[Authenticating the App](./authenticating-the-app.md)</li><li>[Access Manager](../getting-started/access-manager/README.md)</li></ul> |
| ***Starter/v0*** <br><br>Ejectable lazy composition layer for bootstrapping a GHATD application | <ul><li>[Getting Started: starter/v0](../getting-started/starter-v0.md)</li></ul> |
